...
{!! Breadcrumbs::render('pquestions',$conference) !!}
<h2 class="ui dividing header">{{$Q['LIST']}}</h2>
 <a href="{{ route('conferences.pquestions.create', [$conference->confAcronym, $conference->confEdition] ) }}" class="ui primary button show-modal"  ><i class="add square icon"></i> {{$Q['BTN_ADD']}} </a> <hr>
...
var  dt = $('#datatable').DataTable( {
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('conferences.pquestions.indexall', [$conference->confAcronym, $conference->confEdition] ) }}',
