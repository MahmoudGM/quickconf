...
{!! Breadcrumbs::render('crRq',$conference) !!}
@include('layouts.errors')

<form class="ui form" method="POST" action="{{ route('conferences.rquestions.store', [$conference->confAcronym, $conference->confEdition] ) }}">
  {{ csrf_field() }}
  ...
  <div class="field">
    <div class="two fields">
        ...
        <div class="two wide field required">
          <label for="required">{{$Q['PUBLIC']}} </label>
          <input name="public" id="public" required type="number">
        </div>
    </div>
  </div>
